<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('text_before')); ?>:</b>
	<?php echo CHtml::encode($data->text_before); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('text_after')); ?>:</b>
	<?php echo CHtml::encode($data->text_after); ?>
	<br />
