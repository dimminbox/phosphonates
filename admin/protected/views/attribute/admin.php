    ...
    <div class="section_content">
            ...
            <div class="section_content_inner">
                    ...
                    <div class="table_tabs_menu">
                        <a class="update" href="<?=Yii::app()->controller->createUrl("create",array()); ?>"><span><span><em>Добавить аттрибут</em><strong></strong></span></span></a>
                    </div>
