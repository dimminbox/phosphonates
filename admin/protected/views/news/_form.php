...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
        ...
        <div class="row">
            <div class="labels">
                <?php echo $form->labelEx($news_lang,'meta_title'); ?>
            </div>
            <div class="inputs">
                <span class="input_wrapper2">
                   <?php echo $form->textField($news_lang,'meta_title') ?>
                </span>
            </div>
            <?php echo $form->error($news_lang,'meta_title'); ?>
        </div>
        ...
        <div class="row" style="display: none;">
            <div class="labels">
                <?php echo $form->labelEx($news_lang,'short_content'); ?>
            </div>
            <div class="inputs">
        ...
        <div class="row" style="display: none;">
            <div class="labels">
               <?php echo $form->labelEx($news_lang,'image_title'); ?>
            </div>
            <div class="inputs">
                <span class="input_wrapper2">
