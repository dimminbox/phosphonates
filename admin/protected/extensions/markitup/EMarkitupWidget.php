...
class EMarkitupWidget extends CInputWidget
{
	...
	public function run()
	{
            ...
            echo CHtml::script("jQuery('#$this->id').markItUp(mySettings,$options);");
	}
	/**
	...
	protected function registerClientScript()
	{
		...
		$cs->registerCoreScript('jquery');
                echo CHtml::scriptFile($this->scriptUrl.'/'.$this->scriptFile);
                echo CHtml::scriptFile($this->settingsUrl.'/'.$this->settings.'/set.js');
		...
		//$options=CJavaScript::encode($this->options);
                ...
                //echo CHtml::script("jQuery('#$id').markItUp(mySettings,$options);");
                
		//$cs->registerCssFile($this->themeUrl.'/'.$this->theme.'/style.css');
		//$cs->registerCssFile($this->settingsUrl.'/'.$this->settings.'/style.css');
                
                echo CHtml::cssFile($this->themeUrl.'/'.$this->theme.'/style.css');
                echo CHtml::cssFile($this->settingsUrl.'/'.$this->settings.'/style.css');
