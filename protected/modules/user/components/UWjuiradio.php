...
class UWjuiradio {
	...
	public function init() {
		return array(
			'name'=>__CLASS__,
			'label'=>UserModule::t('UWjuiradio',array(),__CLASS__),
	...
	public function editAttribute($model,$field,$htmlOptions=array()) {
		...
		return CHtml::activeRadioButtonList($model,$field->varname,$list,$htmlOptions=array('separator'=>false,'class'=>'radio_type'));
	}
