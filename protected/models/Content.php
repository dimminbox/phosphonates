	...
	public function search()
	{
        ...
        public function AfterSave(){
            ...
            if ($this->getIsNewRecord()){
                $event_lang = new ContentLang;
                $event_lang->attributes = $_POST['ContentLang'];
            ...
            {
                $count = ContentLang::model()->countByAttributes(array('id_event'=>$this->id,'id_lang'=>$id_lang));
                if ($count) {
                    $event_lang = ContentLang::model();
