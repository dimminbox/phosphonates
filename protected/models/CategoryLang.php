...
class CategoryLang extends CActiveRecord
{
	...
	public function relations()
	{
		...
		// class name for the relations automatically generated below.
                //'condition'=>'code=:value','params'=>array('value'=>'"en"')
		return array(
                    'cat_language'=>array(self::HAS_MANY,'Language','','on'=>'id_lang=cat_language.id',
                                          'condition'=>'code=:value','params'=>array('value'=> Yii::app()->params['lang'])),
